...
export const GoogleIcon = (props: StyleProps) => (
  <Icon
    version="1.1"
    viewBox="0 0 150 150"
    xmlSpace="preserve"
  ...
  >
    <g>
      ...
      />
      <path
        fill={props.fill ? (props.fill as string) : "#F6B704"}
        d="M50.1,83.8c-1.9-5.7-1.9-11.9,0-17.6L34.9,54.4c-6.5,13-6.5,28.3,0,41.2L50.1,83.8z"
      />
      <path
        fill={props.fill ? (props.fill as string) : "#E54335"}
...
export const UserIcon = (props: StyleProps) => (
  <Icon
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    {...props}
